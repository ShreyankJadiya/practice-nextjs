  ...
  return (
    <div>
      <Disclosure>
        {({ open }) => (
          <>
            <Disclosure.Button className="fixed z-40 flex items-center justify-center transition duration-300 bg-custom-blue rounded-full shadow-lg right-5 bottom-5 w-14 h-14 focus:outline-none hover:bg-custom-medium-blue focus:bg-custom-medium-blue ease">
            ...
            <Transition
              ...
              <Disclosure.Panel className=" flex flex-col  overflow-hidden left-0 h-full w-full sm:w-[350px] min-h-[250px] sm:h-[600px] border border-gray-300 dark:border-gray-800 bg-white shadow-2xl rounded-md sm:max-h-[calc(100vh-120px)]">
                <div className="flex flex-col items-center justify-center h-32 p-5 bg-custom-blue">
                ...
                <div className="flex-grow h-full p-6 overflow-auto bg-gray-50 ">
                  {!isSubmitSuccessful && (
                    <form onSubmit={handleSubmit(onSubmit)} noValidate>
                      <input
                        type="hidden"
                        value="f0c91d14-bf9a-49ed-8976-37c70d2068f1"
                        {...register("apikey")}
                      />
                      <input
                        type="hidden"
                        value={`${userName} sent a message from The SJ Development`}
                        {...register("subject")}
                      />
                      <input
                        type="hidden"
                        value="SJ Development Live Chat"
                        {...register("from_name")}
                      />
                      <input
                        type="checkbox"
                        ...
                        <input
                          ...
                          className={`w-full px-3 py-2 placeholder-gray-300 bg-white border border-gray-300 rounded-md focus:outline-none focus:ring   ${
                            errors.name
                              ...
                              : "border-gray-300 focus:border-custom-blue ring-indigo-100"
                          }`}
                        />
                        {errors.name && (
                      ...
                      <div className="mb-3">
                        <button
                          type="submit"
                          className="w-full px-3 py-4 text-white bg-custom-blue rounded-md focus:bg-custom-medium-blue focus:outline-none">
                          {isSubmitting ? (
                            <svg
